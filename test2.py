...
def main():
    ...
    root.title("VansAIEngineer -v" + str(version) + " - " + todays_date)
    ...
    if os.path.exists(image_path):
        ...
        img = img.resize((158, 186), Image.LANCZOS)
    ...
    my_light_purple = "#a72ab8"
    my_dark_grey = "#202020"
    # Set the background color and the foreground color of the text area
    text_area_display.config(background=my_dark_grey, foreground=my_light_purple, font=("Courier", 12))
    ...
    text_area_main_user_input.config(background=my_dark_grey, foreground=my_light_purple, font=("Courier", 12))
