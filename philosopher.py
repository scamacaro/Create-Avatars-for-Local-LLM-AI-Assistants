...
def send_message():
    ...
    input_tokens = model.tokenize(b"### Human: " + byte_message + b"\n### Philosopher: Hello there, I am a Philosopher! Let's delve into the depths of thought and explore the nysteres of existence together. I am here for deep conversations.  ")
...
def main():
    ...
    root.title("Philosopher -v" + str(version) + " - " + todays_date)

    # Assign an image file to a variable
    image_path = "philosopher.png"
    ...
    my_dark_green = "#113817"
    my_light_brown = "#705c03"
    # Set the background color and the foreground color of the text area
    text_area_display.config(background=my_light_brown, foreground=my_dark_green, font=("Courier", 12))
    ...
    text_area_main_user_input.config(background=my_light_brown, foreground=my_dark_green, font=("Courier", 12))
